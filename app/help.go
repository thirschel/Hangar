...
func (h helpTypeGeneral) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		"",
		headerStyle.Render("Multi-agent grid:"),
		keyStyle.Render("m")+descStyle.Render("         - Mark/unmark the selected session for the grid"),
		keyStyle.Render("g")+descStyle.Render("         - Open a grid of the marked sessions (2+); click/focus a tile and type"),
		"",
