...
function DiagnosticsPanel({ settings, patch }: DiagnosticsPanelProps): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <details className="diagnostics-experimental">
        <summary>Experimental / advanced</summary>
        <div className="diagnostics-helper">
          Only needed if terminals render blank or garbled. The defaults already handle RDP/VDI and
          no-GPU machines — leave these alone unless you’re troubleshooting.
        </div>
