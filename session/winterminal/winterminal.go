...
// CheckAndHandleTrustPrompt checks the captured content once for a trust prompt
// and dismisses it if found. Returns true if a prompt was found and handled.
func (w *WindowsTerminalSession) CheckAndHandleTrustPrompt() bool {
	content, err := w.CapturePaneContent()
	if err != nil {
		return false
	}
